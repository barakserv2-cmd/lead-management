 ...
 */
/**
 * החלונות הפנויים. ימי הסגירה הידניים חייבים להיות טעונים לפני הקריאה —
 * הקובץ הזה נשאר בלי תלות בדאטהבייס כי קומפוננטות לקוח מייבאות ממנו תוויות,
 * ולכן הטעינה נעשית בנתיב השרת שקורא לפונקציה (ensureClosuresLoaded).
 */
