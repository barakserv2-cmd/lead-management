...
export const assistantTools = [
  ...
  betaZodTool({
    ...
    inputSchema: z.object({
      statuses: z.array(z.enum(ALL_STATUSES as [LeadStatusValue, ...LeadStatusValue[]])).optional().describe("סטטוסים לסינון. ריק = הפייפליין הפעיל (לא כולל נדחה/אבד קשר/לא מתאים/התחיל לעבוד)."),
