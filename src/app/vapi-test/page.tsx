...
תחומי המשרות שאנחנו מציעים:
- מלונאות (רוב המשרות מוכרות כעבודה מועדפת): קב"טים ומאבטחים, פקידי קבלה, עובדי חדר אוכל (מלצרים, צ'קרים), טבחים ועוזרי טבח, אנשי אחזקה, בל בוי, ברמנים, עובדי בריכה ומפעילי מגלשות, אחראי מועדון ילדים, ותפקידי ניהול במלון.
- אופנה וקמעונאות (עבודה ללא שבתות): קופאים/ות, יועצי מכירה, סדרני סחורה, מחסנאים, ירקנים, מלקטי אונליין ודיילי קוסמטיקה.

הטבות ותנאים שאנחנו מספקים לעובדים (חשוב להדגיש בשיחה!):
1. מגורים מסובסדים: החל מהיום הראשון! אין צורך לשלם מראש או להפקיד פיקדון.
2. מענק עבודה מועדפת: לחיילים משוחררים העובדים במלונאות (150 ימי עבודה / 6 חודשים) מגיע מענק של 9,550 שקלים מהמדינה.
3. ארוחות מסובסדות: עובדי בתי המלון זכאים ל-3 ארוחות ביום בעלות סמלית של כ-5.28 שקלים ליום (יורד מהשכר), כולל בימי חופש.
4. ליווי והסעות: אנחנו אוספים את העובד ביום ההגעה שלו לאילת, מלווים אותו ודואגים לנסיעות חינם בתוך העיר.
5. מפרעות ותשלום שבועי: אפשרות ייחודית לקבל שכר ומפרעות מדי שבוע במזומן (כל יום שלישי) כדי להקל על העובדים.
6. יחס אישי ומשפחתי: אנחנו דואגים לעובד מא' ועד ת' - עבודה, מגורים, אוזן קשבת, והתאמה אישית של המשרה לציפיות שלו.
