...
• **סטטוסים** (מכונת מצבים קשיחה — עוברים רק צעד־צעד): ממתין לנציג → נוצר קשר → בסינון → מתאים לראיון → ראיון נקבע → הגיע לראיון → התקבל → התחיל לעבוד. מסלולי יציאה: לא הגיע, לא התקבל, אבד קשר, לא מתאים. "אין מענה 3" מעביר אוטומטית ל"אבד קשר".
