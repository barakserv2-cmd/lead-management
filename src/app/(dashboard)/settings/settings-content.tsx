        ...
        <Link href="/settings/bot">
          <Card className="cursor-pointer hover:shadow-md transition-shadow">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle>בוט הסינון</CardTitle>
                  <CardDescription>
                    מצב הבוט, טיוטות מצב הצל, תור הודעות הפתיחה וניטור המספרים.
                  </CardDescription>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-gray-400">
                  <path d="m15 18-6-6 6-6" />
        ...
        <Link href="/settings/availability">
          <Card className="cursor-pointer hover:shadow-md transition-shadow">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle>זמינות ראיונות</CardTitle>
                  <CardDescription>
                    החלונות השבועיים שלך לתיאום ראיון עצמי — המועמד בוחר מועד פנוי מהלוח שלך.
                  </CardDescription>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-gray-400">
                  <path d="m15 18-6-6 6-6" />
        ...
        <Link href="/settings/closures">
          <Card className="cursor-pointer hover:shadow-md transition-shadow">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle>ימי סגירה</CardTitle>
                  <CardDescription>
                    ימים שבהם לא ייקבעו ראיונות. חגי ישראל חסומים אוטומטית — כאן מוסיפים את השאר.
                  </CardDescription>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-gray-400">
                  <path d="m15 18-6-6 6-6" />
